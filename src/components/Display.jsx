...
function Display() {
  ...
  return (
    ...
    <div className='p-10 relative'>
      <h1 className='text-4xl text-neutral-950 text-center my-10'>Shop by Top Categories</h1>
      <Slider {...settings}>
        ...
        <Link to="/category/smartphones" className='p-4 hover:shadow-lg transition-shadow duration-300'>
          <img src={smartphone} alt="Smartphone" />
          <p className='text-3xl text-center'>Smartphone</p>
        </Link>

        <Link to="/category/mobile-accessories" className='p-4 hover:shadow-lg transition-shadow duration-300'>
          <img src={accessories} alt="Accessories" />
          <p className='text-3xl text-center'>Mobile Accessories</p>
        </Link>
