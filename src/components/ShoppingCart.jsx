            ...
            <div className="max-w-7xl mx-auto p-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2">
                        {Data.map((data, index) => (
                            <div className='flex flex-row mb-6 p-4 border border-gray-300 rounded-lg shadow-sm bg-white' key={index}>
                                <div className='w-32'>
                                    <img src={data.thumbnail} alt={data.title} className='w-full h-auto rounded-md shadow-md' />
                                </div>
                                <div className='flex-grow ml-6'>
                                    ...
                                    <p className='text-sm text-gray-500'>Shipping: {data.shippingInformation || 'Standard'}</p>
                                </div>
                                ...
                                <div className='ml-6'>
                                    <button onClick={() => deleteProduct(index)} className='text-red-600 font-bold text-2xl'>&#215;</button>
                                </div>
                            </div>
                        ))}
                    </div>
